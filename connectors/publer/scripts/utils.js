...
// Script is at: .../GPT/cofounder/connectors/publer/scripts/utils.js
// Memory is at: .../GPT/memory/connectors/publer/
const memoryEnvPath = path.join(__dirname, '..', '..', '..', '..', 'memory', 'connectors', 'publer', '.env');
