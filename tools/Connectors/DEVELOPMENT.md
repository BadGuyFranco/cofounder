...
1. **Identify the pattern** using decision tree above
2. **Copy reference connector** as starting point
3. **Update all file contents** for new platform
4. **Implement core scripts** (usually: auth check, list, CRUD)
5. **Test SETUP.md** with fresh credentials
6. **Write CAPABILITIES.md** based on what you built
7. **Run testing checklist**
8. **Add to Connectors/AGENTS.md** table
